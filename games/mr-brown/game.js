...
function gameRender()
{
    ...
    for (pos.y=0;pos.y<levelSize.y;pos.y++) 
    {
        ...
        if (dragStartPos && pos.x == dragStartPos.x && pos.y == dragStartPos.y){
            drawTile(drawPos, vec2(1.3), data, vec2(341),newColor);
        }else{
            drawTile(drawPos, vec2(1.3), data, vec2(341));
        }
    }
...
engineInit(gameInit, gameUpdate, gameUpdatePost, gameRender, gameRenderPost, 'tilesBrown.png');
